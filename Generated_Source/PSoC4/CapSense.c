...
reg32 * CapSense_pcTable[] = {
    (reg32 *)CapSense_Sns__MatrixButton_Col0__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Col1__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Col2__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Col3__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Row0__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Row1__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Row2__MB__PC, 
    (reg32 *)CapSense_Sns__MatrixButton_Row3__MB__PC, 
};

const uint8 CapSense_portTable[] = {
    CapSense_Sns__MatrixButton_Col0__MB__PORT, 
    CapSense_Sns__MatrixButton_Col1__MB__PORT, 
    CapSense_Sns__MatrixButton_Col2__MB__PORT, 
    CapSense_Sns__MatrixButton_Col3__MB__PORT, 
    CapSense_Sns__MatrixButton_Row0__MB__PORT, 
    CapSense_Sns__MatrixButton_Row1__MB__PORT, 
    CapSense_Sns__MatrixButton_Row2__MB__PORT, 
    CapSense_Sns__MatrixButton_Row3__MB__PORT, 
};

const uint32 CapSense_maskTable[] = {
    CapSense_Sns__MatrixButton_Col0__MB__MASK, 
    CapSense_Sns__MatrixButton_Col1__MB__MASK, 
    CapSense_Sns__MatrixButton_Col2__MB__MASK, 
    CapSense_Sns__MatrixButton_Col3__MB__MASK, 
    CapSense_Sns__MatrixButton_Row0__MB__MASK, 
    CapSense_Sns__MatrixButton_Row1__MB__MASK, 
    CapSense_Sns__MatrixButton_Row2__MB__MASK, 
    CapSense_Sns__MatrixButton_Row3__MB__MASK, 
};

const uint8 CapSense_pinShiftTbl[] = {
    (uint8) CapSense_Sns__MatrixButton_Col0__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Col1__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Col2__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Col3__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Row0__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Row1__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Row2__MB__SHIFT, 
    (uint8) CapSense_Sns__MatrixButton_Row3__MB__SHIFT, 
};
...
const uint8 CapSense_widgetNumber[CapSense_TOTAL_SENSOR_COUNT] = {
    0u, 0u, 0u, 0u, /* MatrixButton__MBCol */
    1u, 1u, 1u, 1u, /* MatrixButton__MBRow */
};
