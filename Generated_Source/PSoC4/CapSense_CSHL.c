...
static uint8 CapSense_debounceCounter[] = {
    2u, 6u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 
};

const uint8 CapSense_rawDataIndex[] = {
    0u, /* MatrixButton__MBCol */
    4u, /* MatrixButton__MBRow */
};

const uint8 CapSense_numberOfSensors[] = {
    4u, /* MatrixButton__MBCol */
    4u, /* MatrixButton__MBRow */
};
...
void CapSense_BaseInit(uint32 sensor)
{
    ...
    debounceIndex = (uint8)sensor - CapSense_rawDataIndex[widget];
    debounceIndex += CapSense_debounceCounter[widget];
    CapSense_debounceCounter[debounceIndex] = CapSense_debounce[widget];
...
uint32 CapSense_CheckIsWidgetActive(uint32 widget)
{
    ...
    widget++;
    rawIndex = CapSense_rawDataIndex[widget];
    numOfSensors = CapSense_numberOfSensors[widget] + rawIndex;
    ...
    do 
    {
        ...
        {
            state |= CapSense_SENSOR_2_IS_ACTIVE;
        }
        rawIndex++;
    }
    while(rawIndex < numOfSensors);
    ...
    if ( ((state & CapSense_SENSOR_1_IS_ACTIVE) != 0u) && \
         ((state & CapSense_SENSOR_2_IS_ACTIVE) != 0u) ) 
    {
...
uint32 CapSense_CheckIsAnyWidgetActive(void)
{
    ...
    {
        if (CapSense_CheckIsWidgetActive(realIndex) != 0u)
        {
            state = CapSense_WIDGET_IS_ACTIVE;
        }
            realIndex += 2u;
