...
#define CapSense_MATRIXBUTTON__MB        (0u)
#define CapSense_MATRIXBUTTON__MB_COL        (0u)
#define CapSense_MATRIXBUTTON__MB_ROW        (1u)
...
#define CapSense_TOTAL_MATRIX_BUTTONS_COUNT          (1u)
