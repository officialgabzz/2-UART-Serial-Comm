// ======================================================================
// 2 UART TEST.v generated from TopDesign.cysch
// 04/04/2017 at 14:53
...
module SCB_P4_v3_20_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("7c22e3c5-da93-4267-9ea2-622856a53add/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7c22e3c5-da93-4267-9ea2-622856a53add/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
