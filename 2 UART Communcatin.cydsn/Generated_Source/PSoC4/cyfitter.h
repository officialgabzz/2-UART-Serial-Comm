...
#define UARTT_isr__INTC_MASK 0x400u
#define UARTT_isr__INTC_NUMBER 10u
#define UARTT_isr__INTC_PRIOR_MASK 0xC00000u
...
#define UARTT_rx__0__DR CYREG_PRT4_DR
#define UARTT_rx__0__HSIOM CYREG_HSIOM_PORT_SEL4
...
#define UARTT_rx__0__INTCFG CYREG_PRT4_INTCFG
#define UARTT_rx__0__INTSTAT CYREG_PRT4_INTSTAT
#define UARTT_rx__0__MASK 0x01u
#define UARTT_rx__0__PC CYREG_PRT4_PC
#define UARTT_rx__0__PC2 CYREG_PRT4_PC2
#define UARTT_rx__0__PORT 4u
#define UARTT_rx__0__PS CYREG_PRT4_PS
#define UARTT_rx__0__SHIFT 0u
#define UARTT_rx__DR CYREG_PRT4_DR
#define UARTT_rx__INTCFG CYREG_PRT4_INTCFG
#define UARTT_rx__INTSTAT CYREG_PRT4_INTSTAT
#define UARTT_rx__MASK 0x01u
#define UARTT_rx__PC CYREG_PRT4_PC
#define UARTT_rx__PC2 CYREG_PRT4_PC2
#define UARTT_rx__PORT 4u
#define UARTT_rx__PS CYREG_PRT4_PS
#define UARTT_rx__SHIFT 0u

/* UARTT_SCB */
#define UARTT_SCB__BIST_CONTROL CYREG_SCB0_BIST_CONTROL
#define UARTT_SCB__BIST_DATA CYREG_SCB0_BIST_DATA
#define UARTT_SCB__CTRL CYREG_SCB0_CTRL
#define UARTT_SCB__EZ_DATA00 CYREG_SCB0_EZ_DATA00
#define UARTT_SCB__EZ_DATA01 CYREG_SCB0_EZ_DATA01
#define UARTT_SCB__EZ_DATA02 CYREG_SCB0_EZ_DATA02
#define UARTT_SCB__EZ_DATA03 CYREG_SCB0_EZ_DATA03
#define UARTT_SCB__EZ_DATA04 CYREG_SCB0_EZ_DATA04
#define UARTT_SCB__EZ_DATA05 CYREG_SCB0_EZ_DATA05
#define UARTT_SCB__EZ_DATA06 CYREG_SCB0_EZ_DATA06
#define UARTT_SCB__EZ_DATA07 CYREG_SCB0_EZ_DATA07
#define UARTT_SCB__EZ_DATA08 CYREG_SCB0_EZ_DATA08
#define UARTT_SCB__EZ_DATA09 CYREG_SCB0_EZ_DATA09
#define UARTT_SCB__EZ_DATA10 CYREG_SCB0_EZ_DATA10
#define UARTT_SCB__EZ_DATA11 CYREG_SCB0_EZ_DATA11
#define UARTT_SCB__EZ_DATA12 CYREG_SCB0_EZ_DATA12
#define UARTT_SCB__EZ_DATA13 CYREG_SCB0_EZ_DATA13
#define UARTT_SCB__EZ_DATA14 CYREG_SCB0_EZ_DATA14
#define UARTT_SCB__EZ_DATA15 CYREG_SCB0_EZ_DATA15
#define UARTT_SCB__EZ_DATA16 CYREG_SCB0_EZ_DATA16
#define UARTT_SCB__EZ_DATA17 CYREG_SCB0_EZ_DATA17
#define UARTT_SCB__EZ_DATA18 CYREG_SCB0_EZ_DATA18
#define UARTT_SCB__EZ_DATA19 CYREG_SCB0_EZ_DATA19
#define UARTT_SCB__EZ_DATA20 CYREG_SCB0_EZ_DATA20
#define UARTT_SCB__EZ_DATA21 CYREG_SCB0_EZ_DATA21
#define UARTT_SCB__EZ_DATA22 CYREG_SCB0_EZ_DATA22
#define UARTT_SCB__EZ_DATA23 CYREG_SCB0_EZ_DATA23
#define UARTT_SCB__EZ_DATA24 CYREG_SCB0_EZ_DATA24
#define UARTT_SCB__EZ_DATA25 CYREG_SCB0_EZ_DATA25
#define UARTT_SCB__EZ_DATA26 CYREG_SCB0_EZ_DATA26
#define UARTT_SCB__EZ_DATA27 CYREG_SCB0_EZ_DATA27
#define UARTT_SCB__EZ_DATA28 CYREG_SCB0_EZ_DATA28
#define UARTT_SCB__EZ_DATA29 CYREG_SCB0_EZ_DATA29
#define UARTT_SCB__EZ_DATA30 CYREG_SCB0_EZ_DATA30
#define UARTT_SCB__EZ_DATA31 CYREG_SCB0_EZ_DATA31
#define UARTT_SCB__I2C_CFG CYREG_SCB0_I2C_CFG
#define UARTT_SCB__I2C_CTRL CYREG_SCB0_I2C_CTRL
#define UARTT_SCB__I2C_M_CMD CYREG_SCB0_I2C_M_CMD
#define UARTT_SCB__I2C_S_CMD CYREG_SCB0_I2C_S_CMD
#define UARTT_SCB__I2C_STATUS CYREG_SCB0_I2C_STATUS
#define UARTT_SCB__INTR_CAUSE CYREG_SCB0_INTR_CAUSE
#define UARTT_SCB__INTR_I2C_EC CYREG_SCB0_INTR_I2C_EC
#define UARTT_SCB__INTR_I2C_EC_MASK CYREG_SCB0_INTR_I2C_EC_MASK
#define UARTT_SCB__INTR_I2C_EC_MASKED CYREG_SCB0_INTR_I2C_EC_MASKED
#define UARTT_SCB__INTR_M CYREG_SCB0_INTR_M
#define UARTT_SCB__INTR_M_MASK CYREG_SCB0_INTR_M_MASK
#define UARTT_SCB__INTR_M_MASKED CYREG_SCB0_INTR_M_MASKED
#define UARTT_SCB__INTR_M_SET CYREG_SCB0_INTR_M_SET
#define UARTT_SCB__INTR_RX CYREG_SCB0_INTR_RX
#define UARTT_SCB__INTR_RX_MASK CYREG_SCB0_INTR_RX_MASK
#define UARTT_SCB__INTR_RX_MASKED CYREG_SCB0_INTR_RX_MASKED
#define UARTT_SCB__INTR_RX_SET CYREG_SCB0_INTR_RX_SET
#define UARTT_SCB__INTR_S CYREG_SCB0_INTR_S
#define UARTT_SCB__INTR_S_MASK CYREG_SCB0_INTR_S_MASK
#define UARTT_SCB__INTR_S_MASKED CYREG_SCB0_INTR_S_MASKED
#define UARTT_SCB__INTR_S_SET CYREG_SCB0_INTR_S_SET
#define UARTT_SCB__INTR_SPI_EC CYREG_SCB0_INTR_SPI_EC
#define UARTT_SCB__INTR_SPI_EC_MASK CYREG_SCB0_INTR_SPI_EC_MASK
#define UARTT_SCB__INTR_SPI_EC_MASKED CYREG_SCB0_INTR_SPI_EC_MASKED
#define UARTT_SCB__INTR_TX CYREG_SCB0_INTR_TX
#define UARTT_SCB__INTR_TX_MASK CYREG_SCB0_INTR_TX_MASK
#define UARTT_SCB__INTR_TX_MASKED CYREG_SCB0_INTR_TX_MASKED
#define UARTT_SCB__INTR_TX_SET CYREG_SCB0_INTR_TX_SET
#define UARTT_SCB__RX_CTRL CYREG_SCB0_RX_CTRL
#define UARTT_SCB__RX_FIFO_CTRL CYREG_SCB0_RX_FIFO_CTRL
#define UARTT_SCB__RX_FIFO_RD CYREG_SCB0_RX_FIFO_RD
#define UARTT_SCB__RX_FIFO_RD_SILENT CYREG_SCB0_RX_FIFO_RD_SILENT
#define UARTT_SCB__RX_FIFO_STATUS CYREG_SCB0_RX_FIFO_STATUS
#define UARTT_SCB__RX_MATCH CYREG_SCB0_RX_MATCH
#define UARTT_SCB__SPI_CTRL CYREG_SCB0_SPI_CTRL
#define UARTT_SCB__SPI_STATUS CYREG_SCB0_SPI_STATUS
...
#define UARTT_SCB__STATUS CYREG_SCB0_STATUS
#define UARTT_SCB__TX_CTRL CYREG_SCB0_TX_CTRL
#define UARTT_SCB__TX_FIFO_CTRL CYREG_SCB0_TX_FIFO_CTRL
#define UARTT_SCB__TX_FIFO_STATUS CYREG_SCB0_TX_FIFO_STATUS
#define UARTT_SCB__TX_FIFO_WR CYREG_SCB0_TX_FIFO_WR
#define UARTT_SCB__UART_CTRL CYREG_SCB0_UART_CTRL
#define UARTT_SCB__UART_RX_CTRL CYREG_SCB0_UART_RX_CTRL
#define UARTT_SCB__UART_RX_STATUS CYREG_SCB0_UART_RX_STATUS
#define UARTT_SCB__UART_TX_CTRL CYREG_SCB0_UART_TX_CTRL
...
#define UARTT_tx__0__DR CYREG_PRT4_DR
#define UARTT_tx__0__HSIOM CYREG_HSIOM_PORT_SEL4
...
#define UARTT_tx__0__INTCFG CYREG_PRT4_INTCFG
#define UARTT_tx__0__INTSTAT CYREG_PRT4_INTSTAT
#define UARTT_tx__0__MASK 0x02u
#define UARTT_tx__0__PC CYREG_PRT4_PC
#define UARTT_tx__0__PC2 CYREG_PRT4_PC2
#define UARTT_tx__0__PORT 4u
#define UARTT_tx__0__PS CYREG_PRT4_PS
#define UARTT_tx__0__SHIFT 1u
#define UARTT_tx__DR CYREG_PRT4_DR
#define UARTT_tx__INTCFG CYREG_PRT4_INTCFG
#define UARTT_tx__INTSTAT CYREG_PRT4_INTSTAT
#define UARTT_tx__MASK 0x02u
#define UARTT_tx__PC CYREG_PRT4_PC
#define UARTT_tx__PC2 CYREG_PRT4_PC2
#define UARTT_tx__PORT 4u
#define UARTT_tx__PS CYREG_PRT4_PS
#define UARTT_tx__SHIFT 1u

/* Miscellaneous */
#define CY_PROJECT_NAME "EMA"
