...
/*******************************************************************************
* Function Name: UARTT_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UARTT_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UARTT_UartCyBtldrCommReset
****************************************************************************//**
*
...
void UARTT_UartCyBtldrCommReset(void)
{
    ...
    UARTT_SpiUartClearRxBuffer();
    UARTT_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UARTT_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UARTT_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UARTT_SpiUartGetRxBufferSize();
                    CyDelayUs(UARTT_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UARTT_SpiUartGetRxBufferSize());

                byteCount = UARTT_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UARTT_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UARTT_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus UARTT_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UARTT_SpiUartPutArray(pData, (uint32) size);
